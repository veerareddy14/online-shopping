							...
							},
							{
								...
								mRender : function(data, type, row) {
									...
									str += '<a href="'
											...
											+ '/show/'
											+ data
											+ '/product" class ="btn btn-primary"><span class= "fas fa-eye"></span></a> &#160;';
									...
									if (userRole == 'ADMIN') {
										str += '<a href="'
												...
												+ '/manage/'
												+ data
												+ '/product" class ="btn btn-warning"><span class= "fas fa-edit"></span></a>';
									} else {
										if (row.quantity < 1) {
											...
											str += '<a href="'
													...
													+ '/cart/add/'
													+ data
													+ '/product" class ="btn btn-success"><span class= "fas fa-shopping-cart"></span></a>';
										}
									}
									return str;
								}
